 ...
 * @Date: 2022-10-09 10:52:35
 * @LastEditors: 夏嫱 xia.qiang3@iwhalecloud.com
 * @LastEditTime: 2023-03-06 14:50:22
 * @FilePath: \code\design-web\src\oss_core\edesign\osp\domain\demandBuilding.js
...
export default class DemandBuilding extends AbstractResource {
  constructor() {
    super();
    this.tempMenuList = this.tempMenuList.concat(menus);
  }
}
DemandBuilding.type = 'A1';
