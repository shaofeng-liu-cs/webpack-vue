<template>
    <Popup :popupObj="popupNew" @popupClose="popupClose" @popupOk="popupOk">
        <template v-slot:popupBody>
            <div>
                <div>
                    <h5>{{ $t('MAP_CON_FUNC_ROOM_INF O ') }}</h5>
                    <form class="contentForm" ref="roomInfo">
                        <div>
                            <div class="content col-md-6">
                                <div class="col-md-5 inputLabel required-label">
                                    <label class="control-label">{{ $t('MAP_CON_FUNC_ROOM_TYP E ') }}</label>
                                </div>
                                <div class="col-md-7">
                            ...
                            <div>
                                <div class="content col-md-6">
                                    ...
                                    <div class="col-md-7">
                                        <input type="text" class="form-control" v-model="row.roomPrefix" name="roomPrefix" />
                                    </div>
                                </div>
                            </div>
                        </div>
...
export default {
    ...
    data() {
        return {
            popupNew: {
                title: this.$t('OSP_MAP_FUNCTION_NEW_ROOM_TITLE'), // 弹框标题
                ok: this.$t('OK'), // 确认按钮内容
