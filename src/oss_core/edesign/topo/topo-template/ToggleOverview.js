...
//   div.style.setProperty('background', ' url(/assets/image/topo-overview/shrink.png) no-repeat', null);
...
//       div.style.setProperty('background-image', 'url(/assets/image/topo-overview/expand.png)', null);
//       div.style.setProperty('width', '24px', null);
//       div.style.setProperty('height', '24px', null);
//       self._expand = false;
//     } else {
...
//       div.style.setProperty('background-image', 'url(/assets/image/topo-overview/shrink.png)', null);
//       div.style.setProperty('width', '24px', null);
//       div.style.setProperty('height', '24px', null);
//       self._expand = true;
//     }
