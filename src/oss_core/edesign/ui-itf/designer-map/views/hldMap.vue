...
// import ResFunctionDialog from '../../../topo/instance/ResFunctionDialog.vue';
// import ResFunctionNoDialog from '../../../topo/instance/ResFunctionNoDialog.vue';
...
export default {
  ...
  methods: {
    ...
    mapSelection(geos) {
      ...
      if (this.queryData.sourceFlag === 'designer-map') {
