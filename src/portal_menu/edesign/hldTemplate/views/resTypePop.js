...
define([
  'text!oss_core/edesign/hldTemplate/templates/resTypePop.html',
  ...
  return portal.BaseView.extend({
    ...
    qryRestype: () => {
      ...
      this.toTypes = newArr;
      HLDTemplateAction.qryAllSurfaceLayers(data => {
      ...
      if (
        ...
        if (this.option.operState === 'M') {
          ...
          if (!fish.isEmpty(sameName) && params.actionName !== this.option.params.actionName) {
            ...
            HLDTemplateAction.editLayerAction(params, data => {
          ...
          HLDTemplateAction.addLayerAction(params, data => {
            this.trigger('okCompleted', data);
          });
          this.$el.dialog('close');
        }
